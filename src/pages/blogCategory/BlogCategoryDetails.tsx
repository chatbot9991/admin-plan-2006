    ...
    <div className="container-fluid p-4 fade-in" style={{ maxWidth: '1400px' }}>
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <p className="text-muted small">مشاهده اطلاعات کامل دسته‌بندی</p>
        </div>
        ...
        <div className="col-lg-8">
          <div className="card border-0 shadow-sm rounded-4 p-4 mb-4 bg-white h-100">
            ...
            <div className="mb-4 border-bottom pb-3">
              <label className="text-muted small text-uppercase fw-bold mb-1">
                عنوان دسته‌بندی
              </label>
            ...
            <div>
              ...
              >
                {category.description ? (
                  ...
                  <span className="text-muted fst-italic">بدون توضیحات</span>
                )}
              </div>
            </div>
          </div>
